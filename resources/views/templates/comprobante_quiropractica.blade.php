...
<html>
    ...
    <body>
        ...
        <label>Nombre: </label><label>{{$citas->nombre}}</label><label> {{$citas->apellido_paterno}}</label><label> {{$citas->apellido_materno}}</label><br><br>
        <label>Consultorio: </label> <label>{{$citas->consultorio}}</label><br><br>
